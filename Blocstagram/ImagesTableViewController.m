...
- (void)refreshControlDidFire:(UIRefreshControl *)sender {
    [[DataSource sharedInstance] requestNewItemsWithCompletionHandler:^(NSError *error) {[sender endRefreshing];}];
}
...
#pragma mark - Camera, CameraViewControllerDelegate, ImagesLibraryViewControllerDelegate
